...
CREATE OR REPLACE FUNCTION "public"."increment_ticket_sold"("ticket_type_id" "uuid", "quantity" integer) RETURNS "void"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  UPDATE ticket_types 
...
ALTER FUNCTION "public"."increment_ticket_sold"("ticket_type_id" "uuid", "quantity" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."nearby_events"("lat" double precision, "lon" double precision, "radius_meters" integer DEFAULT 50000, "limit_count" integer DEFAULT 20, "offset_count" integer DEFAULT 0) RETURNS TABLE("id" "uuid", "title" character varying, "description" "text", "slug" character varying, "start_date" "date", "start_time" time without time zone, "end_date" "date", "end_time" time without time zone, "location_name" character varying, "location_address" "text", "location_coordinates" "point", "location" "public"."geography", "status" "text", "featured" boolean, "created_at" timestamp with time zone, "updated_at" timestamp with time zone, "organizer_id" "uuid", "category_id" "uuid", "capacity" integer, "distance_meters" double precision)
    LANGUAGE "sql" STABLE
    AS $$
  SELECT 
    e.id,
...
ALTER FUNCTION "public"."nearby_events"("lat" double precision, "lon" double precision, "radius_meters" integer, "limit_count" integer, "offset_count" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."sync_location_coordinates"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  -- When location_coordinates is updated, update location column
  IF TG_OP = 'UPDATE' AND (OLD.location_coordinates IS DISTINCT FROM NEW.location_coordinates) THEN
    ...
    ELSE
      NEW.location = NULL;
    END IF;
  -- When inserting with location_coordinates, set location
...
ALTER FUNCTION "public"."sync_location_coordinates"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."sync_location_to_coordinates"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  -- When location is updated directly, update location_coordinates
  IF TG_OP = 'UPDATE' AND (OLD.location IS DISTINCT FROM NEW.location) THEN
    ...
    END IF;
  -- When inserting with location, set location_coordinates  
...
ALTER FUNCTION "public"."sync_location_to_coordinates"() OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."booking_items" (
    ...
    CONSTRAINT "booking_items_total_price_check" CHECK (("total_price" >= (0)::numeric)),
...
CREATE TABLE IF NOT EXISTS "public"."event_categories" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"(),
    "updated_at" timestamp with time zone DEFAULT "now"(),
    CONSTRAINT "event_categories_color_check" CHECK ((("color")::"text" ~ '^#[0-9A-Fa-f]{6}$'::"text"))
);
...
CREATE TABLE IF NOT EXISTS "public"."events" (
    ...
    CONSTRAINT "check_location_valid" CHECK ((("location" IS NULL) OR "public"."st_isvalid"(("location")::"public"."geometry"))),
...
CREATE TABLE IF NOT EXISTS "public"."prices" (
    ...
    CONSTRAINT "prices_interval_check" CHECK (("interval" = ANY (ARRAY['month'::"text", 'year'::"text"]))),
...
CREATE TABLE IF NOT EXISTS "public"."ticket_types" (
    ...
    CONSTRAINT "ticket_types_quantity_available_check" CHECK (("quantity_available" >= 0)),
...
CREATE TABLE IF NOT EXISTS "public"."tickets" (
    ...
    "qr_code" "text",
    "status" "public"."ticket_status" DEFAULT 'issued'::"public"."ticket_status",
...
ALTER TABLE ONLY "public"."events"
    ADD CONSTRAINT "unique_external_event" UNIQUE ("source_platform", "source_event_id");
...
CREATE INDEX "idx_bookings_stripe_payment_intent_id" ON "public"."bookings" USING "btree" ("stripe_payment_intent_id");



CREATE INDEX "idx_bookings_stripe_session_id" ON "public"."bookings" USING "btree" ("stripe_session_id");
...
CREATE INDEX "idx_events_source_lookup" ON "public"."events" USING "btree" ("source_platform", "source_event_id") WHERE (("source_platform" IS NOT NULL) AND ("source_event_id" IS NOT NULL));
...
CREATE INDEX "idx_organizers_stripe_account_id" ON "public"."organizers" USING "btree" ("stripe_account_id");
...
CREATE INDEX "idx_tickets_booking_id" ON "public"."tickets" USING "btree" ("booking_id");
...
CREATE OR REPLACE TRIGGER "sync_location_coordinates_trigger" BEFORE INSERT OR UPDATE ON "public"."events" FOR EACH ROW EXECUTE FUNCTION "public"."sync_location_coordinates"();



CREATE OR REPLACE TRIGGER "sync_location_to_coordinates_trigger" BEFORE INSERT OR UPDATE ON "public"."events" FOR EACH ROW EXECUTE FUNCTION "public"."sync_location_to_coordinates"();



CREATE OR REPLACE TRIGGER "update_booking_items_updated_at" BEFORE UPDATE ON "public"."booking_items" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at_column"();
...
CREATE OR REPLACE TRIGGER "update_event_images_updated_at" BEFORE UPDATE ON "public"."event_images" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at_column"();
...
ALTER TABLE ONLY "public"."booking_items"
    ADD CONSTRAINT "booking_items_ticket_type_id_fkey" FOREIGN KEY ("ticket_type_id") REFERENCES "public"."ticket_types"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."organizers"
    ADD CONSTRAINT "organizers_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE;
...
CREATE POLICY "Anyone can view event images for published events" ON "public"."event_images" FOR SELECT USING (("event_id" IN ( SELECT "events"."id"
   FROM "public"."events"
  WHERE ("events"."status" = 'published'::"public"."event_status"))));



CREATE POLICY "Anyone can view published events" ON "public"."events" FOR SELECT USING (("status" = 'published'::"public"."event_status"));



CREATE POLICY "Anyone can view ticket types for published events" ON "public"."ticket_types" FOR SELECT USING (("event_id" IN ( SELECT "events"."id"
   FROM "public"."events"
  WHERE ("events"."status" = 'published'::"public"."event_status"))));
...
CREATE POLICY "Organizers can create events" ON "public"."events" FOR INSERT WITH CHECK (("organizer_id" IN ( SELECT "organizers"."id"
   FROM "public"."organizers"
  WHERE ("organizers"."user_id" = "auth"."uid"()))));



CREATE POLICY "Organizers can delete their own events" ON "public"."events" FOR DELETE USING (("organizer_id" IN ( SELECT "organizers"."id"
   FROM "public"."organizers"
  WHERE ("organizers"."user_id" = "auth"."uid"()))));



CREATE POLICY "Organizers can manage their event images" ON "public"."event_images" USING (("event_id" IN ( SELECT "e"."id"
...
CREATE POLICY "Organizers can manage their ticket types" ON "public"."ticket_types" USING (("event_id" IN ( SELECT "e"."id"
   FROM ("public"."events" "e"
     JOIN "public"."organizers" "o" ON (("e"."organizer_id" = "o"."id")))
  WHERE ("o"."user_id" = "auth"."uid"()))));
...
CREATE POLICY "Organizers can update their own events" ON "public"."events" FOR UPDATE USING (("organizer_id" IN ( SELECT "organizers"."id"
   FROM "public"."organizers"
  WHERE ("organizers"."user_id" = "auth"."uid"()))));



CREATE POLICY "Organizers can view their own events" ON "public"."events" FOR SELECT USING (("organizer_id" IN ( SELECT "organizers"."id"
   FROM "public"."organizers"
  WHERE ("organizers"."user_id" = "auth"."uid"()))));



CREATE POLICY "System can create tickets" ON "public"."tickets" FOR INSERT WITH CHECK (true);
...
CREATE POLICY "Users can create booking items for their bookings" ON "public"."booking_items" FOR INSERT WITH CHECK (("booking_id" IN ( SELECT "bookings"."id"
...
CREATE POLICY "Users can create their own organizer profile" ON "public"."organizers" FOR INSERT WITH CHECK (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Users can update their own organizer profile" ON "public"."organizers" FOR UPDATE USING (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can view their booking items" ON "public"."booking_items" FOR SELECT USING (("booking_id" IN ( SELECT "bookings"."id"
   FROM "public"."bookings"
  WHERE ("bookings"."user_id" = "auth"."uid"()))));
...
CREATE POLICY "Users can view their own organizer profile" ON "public"."organizers" FOR SELECT USING (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can view their own tickets" ON "public"."tickets" FOR SELECT USING (("booking_id" IN ( SELECT "bookings"."id"
   FROM "public"."bookings"
  WHERE ("bookings"."user_id" = "auth"."uid"()))));
...
GRANT ALL ON FUNCTION "public"."increment_ticket_sold"("ticket_type_id" "uuid", "quantity" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."increment_ticket_sold"("ticket_type_id" "uuid", "quantity" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."increment_ticket_sold"("ticket_type_id" "uuid", "quantity" integer) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."nearby_events"("lat" double precision, "lon" double precision, "radius_meters" integer, "limit_count" integer, "offset_count" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."nearby_events"("lat" double precision, "lon" double precision, "radius_meters" integer, "limit_count" integer, "offset_count" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."nearby_events"("lat" double precision, "lon" double precision, "radius_meters" integer, "limit_count" integer, "offset_count" integer) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."sync_location_coordinates"() TO "anon";
GRANT ALL ON FUNCTION "public"."sync_location_coordinates"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."sync_location_coordinates"() TO "service_role";



GRANT ALL ON FUNCTION "public"."sync_location_to_coordinates"() TO "anon";
GRANT ALL ON FUNCTION "public"."sync_location_to_coordinates"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."sync_location_to_coordinates"() TO "service_role";
